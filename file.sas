...
/*************Start a CAS Session*************/ cas mySession sessopts=(caslib-casuser timeout-1800 locale=”en_US”);
...
Load casdata=”accountfinancials_final.sashdat” incaslib=”STG_SnB” outcaslib=”CASUSER” casout=”accountfinancials_final” replace;

Load casdata=”contract_info_first_final.sashdat” incaslib=”STG_SnB” outcaslib=”CASUSER” casout=”contract_info_first_final” replace; load casdata=”rate_info_final.sashdat” incaslib=”STG SnB” outcaslib=”CASUSER”
...
Load casdata-“arrears_info.sashdat” incaslib=”STG_SnB” outcaslib=”CASUSER” casout-“arrears_info” replace;
...
LEFT JOIN CASUSER. Booked_eff_date_accounts final t3 ON (t7.Account Number = t3.Account Number) LEFT JOIN CASUSER.broker_info t2 ON (t7.BrokerId = t2.BrokerId)

LEFT JOIN CASUSER.balance_info t5 ON (t7.Account Number = t5.Account Number) LEFT JOIN CASUSER.arrears_info t8 ON (t7.Account Number = t8.Account Number)
...
If &DEBUG = N %then %do; proc casutil incas lib=”CASUSER” outcaslib=”VA_SnB”;
...
%put Loading table back into memory (VA_SnB)….; proc casutil;

Load casdata=”AR_to_chicago.sashdat” incaslib=”VA_SnB” outcaslib=”VA_SnB” casout=”AR to chicago” promote;
